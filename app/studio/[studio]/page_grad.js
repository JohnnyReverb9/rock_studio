...
export default function StudioPage({ params }) {
  ...
  return (
    <div className="min-h-screen flex flex-col text-gray-900">
      ...
      <section id="gallery" className="py-20 px-6 bg-gradient-to-b from-gray-200 to-gray-50 bg-[url('/background_blur.jpg')] bg-cover bg-center bg-fixed">
      ...
      <section id="contacts" className="py-20 px-6 bg-gradient-to-b from-gray-50 to-white text-center">
